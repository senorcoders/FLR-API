...
exports.update = function(req, res, callback){
    ...
    con.connect().then(function () { 
        console.log("moment request at "+moment().format('YYYY-MM-DD'));
        new con.Request("update [users] set name=@name, username=@username, phone=@phone, password=@password, email=@email, birthday=@birthday, lat=@lat, lon=@lon, photo_url=@photo_url, updated_at=@updated_at, social_access_token=@social_access_token  where id = @id; select * from [users] where id = @id;") 
        .addParam("id", TYPES.Int, Number(req.params.userId)  )
        .addParam("name", TYPES.VarChar, req.body.name) 
        .addParam("username", TYPES.VarChar, req.body.username) 
