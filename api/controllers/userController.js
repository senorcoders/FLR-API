...
exports.create = function(req, res, callback){
	...
	console.log('--------------req----------------');
	console.log(req);
         new con.Request("insert into [users] (name, username, password, email, birthday, lat, lon, created_at, updated_at, verification_code, photo_url, azure_id) values( @name, @username, @password, @email, @birthday, @lat, @lon, @created_at, @updated_at, @verification_code, @photo_url, @azure_id); select * from [users] where id = scope_identity();") 
