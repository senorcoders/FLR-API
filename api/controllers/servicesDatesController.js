                    ...
                    forEach(hours, function(hour, indexHour, arrHour) {                                
                        ...
                        .then(function (all_reservations){
                            forEach(all_reservations, function(reservation, indexReservation, arrReservation) {                                
                                ...
                                //arrHour[indexHour].dataValues.productMaxAdults = arrReservation[indexReservation].productMaxAdults ;
                                //arrHour[indexHour].dataValues.productMaxChilds = arrReservation[indexReservation].productMaxChilds ;
                                /*arrHour[indexHour].dataValues.adultReserved = arrReservation[indexReservation].adultReserved ;
                                arrHour[indexHour].dataValues.childReserved = arrReservation[indexReservation].childReserved ;
                                arrHour[indexHour].dataValues.inPartyReserved = arrReservation[indexReservation].inPartyReserved ;
                                arrHour[indexHour].dataValues.available = arrHour[indexHour].dataValues.productMaxAdults+arrHour[indexHour].dataValues.productMaxChilds;
                                arrHour[indexHour].dataValues.TotalReserved = arrHour[indexHour].dataValues.childReserved +arrHour[indexHour].dataValues.adultReserved;
                                arrHour[indexHour].dataValues.TotalAvailable = arrHour[indexHour].dataValues.productMaxAdults+arrHour[indexHour].dataValues.productMaxChilds-arrHour[indexHour].dataValues.childReserved - arrHour[indexHour].dataValues.adultReserved;    */
                                //doneReservation();
                            }, reservationDone);
                        ...
                        /*reservations.findAll({ where: {transaction_start_date : date, transaction_start_time: hour.start_hours } } )
                        .then(function (all_reservations){
                            forEach(all_reservations, function(reservation, indexReservation, arrReservation) {                                
                                var doneReservation = this.async();
                                arrHour[indexHour].dataValues.reservations = arrReservation;    
                                doneReservation();
                            }, reservationDone);
